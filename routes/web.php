...
Route::middleware('auth')->group(function (): void {
    ...
    // posts
    Route::get('/posts/{subreddit}/create', [PostController::class, 'create'])->name('posts.create');
    ...
    Route::delete('/r/{subreddit:slug}/delete', [SubredditController::class, 'destroy'])->name('subreddits.destroy');
});
